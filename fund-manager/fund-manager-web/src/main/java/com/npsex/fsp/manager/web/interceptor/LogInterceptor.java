...
public class LogInterceptor {
	 ...
	 */
	@Pointcut("execution(* com.npsex.fsp.manager.controller.*.add(..))")
	 ...
	 */
	@Pointcut("execution(* com.npsex.fsp.manager.controller.*.update(..)) "
			+ "|| execution(* com.npsex.fsp.manager.controller.*.resetPassword(..)) "
			+ "|| execution(* com.npsex.fsp.manager.controller.*.info(..)) "
			+ "|| execution(* com.npsex.fsp.manager.controller.*.password(..))")
	 ...
	 */
	@Pointcut("execution(* com.npsex.fsp.manager.controller.*.delete*(..))")
	 ...
	 */
	@Pointcut("execution(* com.npsex.fsp.manager.controller.*.permission(..))")
