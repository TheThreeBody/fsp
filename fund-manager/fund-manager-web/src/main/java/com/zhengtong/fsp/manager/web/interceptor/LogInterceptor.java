...
public class LogInterceptor {
	 ...
	 */
	@Pointcut("execution(* com.zhengtong.fsp.manager.controller.*.add(..))")
	 ...
	 */
	@Pointcut("execution(* com.zhengtong.fsp.manager.controller.*.update(..)) "
			+ "|| execution(* com.zhengtong.fsp.manager.controller.*.resetPassword(..)) "
			+ "|| execution(* com.zhengtong.fsp.manager.controller.*.info(..)) "
			+ "|| execution(* com.zhengtong.fsp.manager.controller.*.password(..))")
	 ...
	 */
	@Pointcut("execution(* com.zhengtong.fsp.manager.controller.*.delete*(..))")
	 ...
	 */
	@Pointcut("execution(* com.zhengtong.fsp.manager.controller.*.permission(..))")
