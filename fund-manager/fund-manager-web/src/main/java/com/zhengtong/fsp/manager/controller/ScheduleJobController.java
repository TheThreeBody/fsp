package com.zhengtong.fsp.manager.controller;
...
public class ScheduleJobController {
	...
	public String planJobListUI(Model model) {
		try {
			return SysConstant.BACKGROUND_PATH + "/schedule/planningList";
		} catch (Exception e) {
	...
	public String runningJobListUI(Model model) {
		try {
			return SysConstant.BACKGROUND_PATH + "/schedule/runningList";
		} catch (Exception e) {
			throw new AjaxException(e);
		}
	}
	...
	public String jobTriggerListUI(Model model, ScheduleJob job) {
		try {
			model.addAttribute("scheduleJobEntity", job);
			return SysConstant.BACKGROUND_PATH + "/schedule/triggerList";
		} catch (Exception e) {
			throw new AjaxException(e);
		}
	}
	...
	public Object planJobList(String timestamp) throws Exception {
		// 1、映射Pager对象
		List<ScheduleJob> list = scheduleJobService.getPlanJobList();
		// 列表展示数据
		return list;
	}
	...
	public Object runningJobList(String timestamp) throws Exception {
		// 1、映射Pager对象
		List<ScheduleJob> list = scheduleJobService.getRunningJobList();
		// 列表展示数据
		return list;
	}
	...
	@ResponseBody
	public Object jobTriggerList(ScheduleJob job) throws Exception {
		List<ScheduleJob> list = scheduleJobService.getTriggers(job);
		// 列表展示数据
		return list;
	}
	...
	public String addJobUI(Model model) {
		try {
			...
			return SysConstant.BACKGROUND_PATH + "/schedule/jobForm";
		} catch (Exception e) {
			throw new AjaxException(e);
		}
	}
	...
	public String addTriggerUI(Model model,ScheduleJob job) {
		try {
			model.addAttribute("jobGroup", JSONArray.parseArray(jobGroup).toArray());
			model.addAttribute("scheduleJobEntity", job);
			return SysConstant.BACKGROUND_PATH + "/schedule/triggerForm";
		} catch (Exception e) {
			throw new AjaxException(e);
		}
	}
	...
	@ResponseBody
	public Object addQuartzJob(ScheduleJob job) {
	...
	@ResponseBody
	public Object addQuartzTrigger(ScheduleJob job) {
		Map<String, Object> map = new HashMap<String, Object>();
		try {
			Scheduler scheduler = schedulerFactoryBean.getScheduler();
	...
	public String editUI(Model model, ScheduleJob job) {
		try {
			ScheduleJob scheduleJobEntity = scheduleJobService.getScheduleJobEntity(job);
			model.addAttribute("jobGroup", JSONArray.parseArray(jobGroup).toArray());
	...
	@ResponseBody
	public Object updateQuartzTrigger(ScheduleJob job) {
		Map<String, Object> map = new HashMap<String, Object>();
		try {
	...
	@ResponseBody
	public Object pauseQuartzJob(ScheduleJob job) {
		Map<String, Object> map = new HashMap<String, Object>();
		try {
	...
	@ResponseBody
	public Object pauseQuartzTrigger(ScheduleJob job) {
		Map<String, Object> map = new HashMap<String, Object>();
		try {
	...
	@ResponseBody
	public Object resumeQuartzJob(ScheduleJob job) {
		Map<String, Object> map = new HashMap<String, Object>();
		try {
	...
	@ResponseBody
	public Object resumeQuartzTrigger(ScheduleJob job) {
		Map<String, Object> map = new HashMap<String, Object>();
		try {
	...
	@ResponseBody
	public Object deleteQuartzJob(ScheduleJob job) {
		Map<String, Object> map = new HashMap<String, Object>();
		try {
	...
	@ResponseBody
	public Object deleteQuartzTrigger(ScheduleJob job) {
		Map<String, Object> map = new HashMap<String, Object>();
		try {
	...
	@ResponseBody
	public Object executeQuartzJob(ScheduleJob job) {
		Map<String, Object> map = new HashMap<String, Object>();
		try {
	...
	@ResponseBody
	public Object interruptQuartzJob(ScheduleJob job) {
		Map<String, Object> map = new HashMap<String, Object>();
		try {
