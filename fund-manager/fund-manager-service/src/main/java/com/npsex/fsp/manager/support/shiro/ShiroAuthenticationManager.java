...
import com.npsex.fsp.manager.service.UserSessionService;
import com.npsex.fsp.commons.utils.SpringUtils;
...
public class ShiroAuthenticationManager {
	 ...
	 * 用户权限管理
	 */
	public static final MyDBRealm myDBRealm = SpringUtils.getBean("myDBRealm", MyDBRealm.class);
	/*
	 * 用户session管理
	 */
