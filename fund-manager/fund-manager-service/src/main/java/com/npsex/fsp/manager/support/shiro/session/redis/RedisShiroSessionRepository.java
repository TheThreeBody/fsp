package com.npsex.fsp.manager.support.shiro.session.redis;

import com.npsex.fsp.manager.support.redis.RedisManager;
import com.npsex.fsp.manager.support.shiro.session.SessionStatus;
