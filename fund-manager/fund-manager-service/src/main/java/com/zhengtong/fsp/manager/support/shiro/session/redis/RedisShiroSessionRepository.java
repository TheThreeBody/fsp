package com.zhengtong.fsp.manager.support.shiro.session.redis;
...
import com.zhengtong.fsp.manager.support.shiro.session.ShiroSessionRepository;
import com.zhengtong.fsp.commons.utils.SerializeUtil;
import com.zhengtong.fsp.manager.service.impl.UserSessionServiceImpl;
...
public class RedisShiroSessionRepository implements ShiroSessionRepository {
    private static final Logger logger = LogManager.getLogger(RedisShiroSessionRepository.class);
