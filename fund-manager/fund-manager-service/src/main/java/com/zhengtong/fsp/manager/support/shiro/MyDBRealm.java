package com.zhengtong.fsp.manager.support.shiro;

import com.zhengtong.fsp.manager.support.shiro.filter.ShiroUtils;
import com.zhengtong.fsp.manager.support.shiro.util.MyByteSource;
import com.zhengtong.fsp.manager.mapper.vocs.ResourceMapper;
import com.zhengtong.fsp.manager.mapper.vocs.UserMapper;
...
public class MyDBRealm extends AuthorizingRealm {
	 ...
	 * </br>另外如果密码重试次数太多将调用LimitRetryCredentialsMatcher（HashedCredentialsMatcher子类）抛出超出重试次数异常ExcessiveAttemptsException；
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
		...
		if (userEntity != null) {
            ...
            authenticationInfo = new SimpleAuthenticationInfo(
					...
					//ByteSource.iP2RegionUtil.bytes(username + userEntity.getCredentialsSalt()),// salt=username+salt
